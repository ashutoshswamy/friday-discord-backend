        ...
        try {
            ...
            if (subcommand === 'train') {
                ...
                if (attribute === 'attack') {
                    ...
                    attributeText = `🛡️ **Defense Rating** increased from \`${pet.defense}\` to \`${pet.defense + 1}\`! (Bite chance: \`${Math.min(50, 10 + (pet.defense + 1) * 1.5)}%\`)`;
                }
