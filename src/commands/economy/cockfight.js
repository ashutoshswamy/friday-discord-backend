            ...
            const container = new ContainerBuilder()
                    ...
                    new SectionBuilder()
                        .addTextDisplayComponents(
                            new TextDisplayBuilder().setContent(
                                `## 🐓 Cockfight Arena\n### ⚔️ ${playerBird} vs ${opponentBird} ⚔️\n\n${finalStatus}\n\n` +
                ...
                .addTextDisplayComponents(
                    new TextDisplayBuilder().setContent(
                        ...
                        `**Payout:** ${winnings > 0 ? `<:coin:1512926963239489606> **+${winnings.toLocaleString()}**` : '<:coin:1512926963239489606> **0**'}\n` +
                        `**Wallet:** <:coin:1512926963239489606> **${finalBalance.coins.toLocaleString()}** coins`
                    )
                )
                .addSeparatorComponents(new SeparatorBuilder().setSpacing(SeparatorSpacingSize.Small))
                .addTextDisplayComponents(
                    new TextDisplayBuilder().setContent('-# ⚠️ High stakes cockfight arena matches. 50% chance of win or loss.')
                );
