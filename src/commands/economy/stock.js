...
module.exports = {
                ...
                .addStringOption(opt =>
                    opt.setName('market')
                        ...
                        .addChoices(
                            ...
                            { name: '<:coin:1512926963239489606> Crypto Currency', value: 'CRYPTO' },
    ...
    async execute(interaction) {
        ...
        const getFlag = mkt => mkt === 'NASDAQ' ? '🇺🇸' : mkt === 'NSE' ? '🇮🇳' : mkt === 'LSE' ? '🇬🇧' : mkt === 'CRYPTO' ? '<:coin:1512926963239489606>' : mkt === 'TYO' ? '🇯🇵' : '🇦🇺';
