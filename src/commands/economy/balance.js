        ...
        try {
            ...
            if (isSelf) {
                ...
                const shopBtn = new ButtonBuilder()
                    .setCustomId('bal_view_shop').setLabel('🛍️ View Shop').setStyle(ButtonStyle.Secondary);
            ...
            collector.on('collect', async i => {
                if (i.customId === 'bal_deposit_all') {
                    ...
                    const shopBtn = new ButtonBuilder().setCustomId('bal_view_shop').setLabel('🛍️ View Shop').setStyle(ButtonStyle.Secondary);
