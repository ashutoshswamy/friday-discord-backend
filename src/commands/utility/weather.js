...
module.exports = {
 ...
 if (lowerDesc.includes('rain') || lowerDesc.includes('drizzle')) weatherIcon = '';
 else if (lowerDesc.includes('snow') || lowerDesc.includes('sleet')) weatherIcon = '';
 else if (lowerDesc.includes('thunder') || lowerDesc.includes('storm')) weatherIcon = '';
 else if (lowerDesc.includes('cloud') || lowerDesc.includes('overcast')) weatherIcon = '';
 else if (lowerDesc.includes('fog') || lowerDesc.includes('mist') || lowerDesc.includes('haze')) weatherIcon = '';
