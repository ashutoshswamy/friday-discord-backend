...
const pages = {
 ...
 { name: '`/lottery view`', value: 'View the daily lottery jackpot pool, ticket prices, draw timers, and your winning odds.' },
 { name: '`/lottery buy [amount]`', value: 'Purchase tickets for the daily lottery jackpot draw (100 coins each).' },
 { name: '`/lottery draw`', value: 'Immediately draw the daily lottery jackpot and distribute rewards (Admin).' },
 ...
 { name: '`/farm view`', value: 'View your garden plots, crop growth stages, active fertilizers, pests, and farming skill level.' },
 { name: '`/farm plant [seed] [plot]`', value: 'Plant a seed from your inventory on a specific empty garden plot.' },
 { name: '`/farm water [plot]`', value: 'Water a growing crop to speed up growth by 25%. Damp soil has a 15% chance to attract pests.' },
 { name: '`/farm fertilize [fertilizer] [plot]`', value: 'Apply Basic Fertilizer (+50% speed), Growth Serum (instant ready), or Yield Booster (double harvest).' },
 { name: '`/farm treat [plot]`', value: 'Cure a pest infestation on a plot. Requires Pesticide in your inventory.' },
 { name: '`/farm harvest [plot]`', value: 'Harvest a fully-grown clean crop. Higher farming level increases Silver/Gold Star quality odds.' },
 { name: '`/farm expand`', value: 'Buy another garden plot (up to 8 max) to plant more crops concurrently.' },
 ...
 { name: '`/shop catalog`', value: 'Complete 2-page item encyclopedia — tools, seeds, consumables, collectibles, craftables, and all grind drops.' },
 ...
 { name: '`/use [item]`', value: 'Consumes items for perks: Pizza (150 XP), XP Potion (300 XP), Energy Drink / Gamer Energy Drink (300 coins), Work Gloves (500 coins), Coin Bomb (800–4,000 coins), Lootbox / Prize Box, Mystery Crate.' },
 ...
 fields: [
 { name: '`/automod toggle/blocklist/whitelist/optout/punishments`', value: 'Configures live spam filters, caps locks, link blockers, per-channel opt-outs, bypass exceptions, and escalation punishments (Admin).' },
 { name: '`/warn [user]`', value: 'Logs formal warning strike against member profile records — reason entered via modal popup (Admin).' },
 ...
 { name: '`/poll create [question] [options] [duration?] [multiselect?]`', value: 'Posts a poll with up to 10 options. Optional duration in hours (default 24h) and multi-select toggle.' },
 { name: '`/poll close [id]`', value: 'Closes an active poll by message ID and posts final vote results (Admin).' },
 { name: '`/embed create`', value: 'Opens a modal wizard to build and post a custom rich embed card.' },
 ...
 { name: '`/bio [text?] [clear?]`', value: 'Set your personal tagline/bio (max 150 chars). Use `/bio` alone to view, or `clear: true` to wipe it.' },
